...
require_once( dirname( __FILE__ )."/dashboard/muhtmlfunctions.php" );
...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<div class="center-box main-form stats-area">
				<h1>Stats</h1>
				<h2>Analyzing Your Link Data</h2>
				<p id="longurl" class="url-display">
					<span class="label">
						<?php yourls_e( 'Full URL'); ?>:
					</span> 
					<?php yourls_html_link( $longurl, yourls_trim_long_string( $longurl ), 'longurl' ); ?>
				</p>
				<p id="shorturl" class="url-display">
					<span class="label" >
						<?php yourls_e( 'Shortlink'); ?>:
					</span>
					<?php if( $aggregate ) {
						$i = 0;
				...
				<div id="tabs">
					...
					<ul id="headers" class="toggle_display stat_tab">
						...
						<li class="selected"><a href="#stat_tab_stats" class="btn btn-primary"><?php yourls_e( 'Stats'); ?></a></li>
						<li><a href="#stat_tab_location" class="btn btn-primary" ><?php yourls_e( 'Location'); ?></a></li>
						<li><a href="#stat_tab_sources" class="btn btn-primary"><?php yourls_e( 'Sources'); ?></a></li>
						<?php } ?>
						<li><a href="#stat_tab_share" class="btn btn-primary"><?php yourls_e( 'Share'); ?></a></li>
					</ul>
					</div>
					...
					<div id="stat_tab_stats" class="tab">
						...
						<?php if ( $list_of_days ) { ?>
							...
							<div class="row">
								...
								<div class="col-md-6 historical-click-count">
				...
				<?php } // endif do log redirect ?>
					...
					<div id="stat_tab_share" class="tab">
						...
						<?php display_share_box( $longurl, yourls_link($keyword), $title, '', '<h3>' . yourls__( 'Short link' ) . '</h3>', '<h3>' . yourls__( 'Quick Share' ) . '</h3>'); ?>
					</div>
