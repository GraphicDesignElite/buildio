...
function yourls_html_logo() {
	...
	<header role="banner">
	<h1>
		<img src="<?php yourls_site_url(); ?>/public/images/ibuild.logo.png" alt="iBuild" title="iBuild Admin" border="0" style="border: 0px; width:200px; margin-top:30px;" /></a>
	</h1>
	</header>
	<?php
...
<head>
	...
	<link rel="stylesheet" href="<?php yourls_site_url(); ?>/css/styleOR.css?v=<?php echo YOURLS_VERSION; ?>" type="text/css" media="screen" />
	<?php if ( $tabs ) { ?>
...
function yourls_html_addnew( $url = '', $keyword = '' ) {
	...
	<div id="new_url">
		<div class="row">
			<form id="newurl" action="" method="get">
			<div class="col-md-4">
				<div class="form-group">
					<label><?php yourls_e( 'Enter the URL' ); ?></label>
					<input type="url" id="add-url" name="url" value="<?php echo $url; ?>" class="form-control input-lg" size="80" placeholder="https://" required />
				</div>
			</div>
			<div class="col-md-4">	
				<div class="form-group">
					<label><?php yourls_e('Custom short URL'); ?></label>
					<input type="text" id="add-keyword" name="keyword" value="<?php echo $keyword; ?>" class="form-control input-lg" size="8" />
